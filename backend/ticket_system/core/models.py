...
class EventTicket(models.Model):
    ...
    is_purshased = models.BooleanField(default=False)
...
class EventStats(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='actions')
