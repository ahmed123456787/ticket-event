# Generated by Django 5.2.1 on 2025-07-12 16:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('organizer', 'Organizer'), ('admin', 'Admin'), ('visitor', 'Visitor')], default='admin', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_banner', models.ImageField(blank=True, null=True, upload_to='staticfiles/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_type', models.CharField(choices=[('STANDARD', 'Standard'), ('VIP', 'VIP'), ('EARLY_BIRD', 'Early Bird')], default='STANDARD', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['event', 'action_type'], name='core_events_event_i_0d4ec0_idx'), models.Index(fields=['timestamp'], name='core_events_timesta_1f00e2_idx')],
            },
        ),
    ]
